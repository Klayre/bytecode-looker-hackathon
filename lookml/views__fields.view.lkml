view: views__fields {
  ...
  derived_table: {
    ...
    select  v.sha::varchar as view_sha,
    v.path::varchar as view_path,
    v.name::varchar as view_name,
    v.git_owner::varchar as git_owner,
    v.git_repository::varchar as git_repository,
    v.sql_table_name::varchar as sql_table_name,
    ...
    NULL::varchar as "interval",
    CASE WHEN dg.value:label::varchar IS NOT NULL THEN dg.value:label::varchar || ' ' || initcap(dgtf.value::varchar) ELSE initcap(dgtf.value::varchar) END as label,
    ...
    , lateral flatten(input => dg.value:timeframes) dgtf
      ...
      CASE WHEN dg.value:label::varchar IS NOT NULL THEN dg.value:label::varchar || ' ' || initcap(dgint.value::varchar) ELSE initcap(dgint.value::varchar) END as label,
      ...
      m.value:approximate_threshold::float as approximate_threshold,
      NULL::varchar as bypass_suggest_restrictions,
      ...
      NULL::varchar as full_suggestions,
      ...
      NULL::varchar as direction,
      NULL::variant as drill_fields,
      NULL::varchar as fanout_on,
      NULL::variant as filters,
      ...
      NULL::varchar as group_item_label,
